...
namespace SystemIO.tests
{
    ...
    public class ReopTests
    {
        ...
        private const string _originalData = @"E:\workspace\SG-works\assignments\SMS\Data\SystemIO\StudentTestSeed.txt";

        //use the setup method to ensure a clean start for a new test.
        [SetUp]
        public void Setup()
        {
